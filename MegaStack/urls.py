...
from MegaStack.core_settings.common import DEBUG

from apps.core.swagger import DecoratedTokenObtainPairView, DecoratedTokenRefreshView, \
...
admin.site.site_header = 'MegaStack'
